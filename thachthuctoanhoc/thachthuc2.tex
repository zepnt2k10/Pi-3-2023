...
\begin{multicols}{2}
	...
	(Mức $B$) Ký hiệu $N$ là tích của $5$ số nguyên tố đầu tiên. Hỏi, có bao nhiêu số nguyên dương $d$ thoả mãn $N^2$ chia hết cho $d$, nhưng $N$ không chia hết cho $d$?
	\begin{flushright}
		\textit{\small{Trích Đề thi VMTC $2022$--Vòng $1$-- Khối lớp $8$}}
	\end{flushright}
	{\color{thachthuctoanhoc}{\usefont{T5}{qag}{b}{n} P684.}}
	(Mức $B$) Bạn Tùng muốn tô $9$ ô vuông con của bảng ô vuông $3\times 3$ bởi $5$ màu xanh, đỏ, vàng, nâu, tím, sao cho mỗi ô được tô bởi một màu và hai ô có cạnh chung có màu khác nhau. Hỏi Tùng có tất cả bao nhiêu phương án tô?
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
	...
	(Mức $B$) Một chiếc bánh được chia thành $9$ miếng như hình vẽ và chú chuột lần lượt chọn từng miếng trong $9$ miếng đó để ăn. Miếng thứ nhất chú chọn là một trong $4$ miếng góc. Từ miếng thứ hai, miếng được chọn bao giờ cũng nằm kề (chung cạnh) với miếng vừa được chọn trước đó. Hỏi chú chuột có bao nhiêu cách chọn đủ $9$ miếng?
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
		\captionsetup{labelformat= empty, justification=centering}
	...
	(Mức $A$) Tìm tất cả các cặp số thực $(p;q)$ thoả mãn: phương trình 
	$x^3-px+q=0$ có ba nghiệm thực $a,b,c$ thoả mãn $a<b<c$ và
	\begin{align*}
		a^2-b=b^2-c=c^2-a.
	\end{align*}
	\begin{flushright}
		\textit{\small{Nguyễn Anh Vũ, Bình Định}}
	\end{flushright}
	{\color{thachthuctoanhoc}{\usefont{T5}{qag}{b}{n} P688.}}
	(Mức $A$) Cho số nguyên tố $p$. Người ta cho máy tính chạy một chương trình liệt kê các số nguyên tố theo quy tắc sau: Ban đầu máy tính hiển thị số $p$. Sau đó, cứ sau mỗi giây, máy tính hiển thị thêm một số nguyên tố mới, khác với các số đã có trước đó, và sao cho hai số được hiển thị ở hai giây liên tiếp sai khác nhau không vượt quá $2023$. Chứng minh rằng, sau một thời gian nhất định, chương trình sẽ dừng lại.
	\begin{flushright}
	...
	\end{figure}
	\begin{flushright}
		\textit{Nguyễn Khang, Cần Thơ}
	\end{flushright}
	{\color{thachthuctoanhoc}{\usefont{T5}{qag}{b}{n} P690.}}
	(Mức $A$) Có $20$ tấm bìa, đánh số từ $1$ đến $20$. Trên tấm bìa thứ $m$ có viết một số thực $a_m$ sao cho $[a_m] = m$. Chứng minh rằng có thể chọn ra $4$ tấm bìa sao cho tổng các số trên hai tấm bìa đầu tiên và tổng các số trên hai tấm bìa còn lại có sai khác nhỏ hơn $\dfrac16$.
	\begin{flushright}
