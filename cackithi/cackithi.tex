...
\AddToShipoutPicture*{\put(150,575){\includegraphics[scale=1]{../tieude.pdf}}}
\centering
\endgroup
\vspace*{130pt}
...
%	\vskip 0.1cm
%	Vậy giá trị nhỏ nhất của $X$ là: $2\times 12\times3 = 6$.
%	\vskip 0.1cm
%	Đáp số: $6$
	...
	\begin{figure}[H]
		...
		\captionsetup{labelformat= empty, justification=centering}
		\begin{tikzpicture}
			\fill[cackithi] (0,0) circle (1.5pt);
			\fill[cackithi] (0,1) circle (1.5pt);
			\fill[cackithi] (1,0) circle (1.5pt);
			\fill[cackithi] (1,1) circle (1.5pt);
			\fill[cackithi] (0,2) circle (1.5pt);
			\fill[cackithi] (2,0) circle (1.5pt);
			\fill[cackithi] (1,2) circle (1.5pt);
			\fill[cackithi] (2,2) circle (1.5pt);
		\end{tikzpicture}
		\vspace*{-10pt}
	\end{figure}
%	Lời giải.
...
%	Số cách chọn $3$ điểm: 
%	\begin{align*}
%		C_3^8 = \frac{8\times 7 \times 6}{3!} = 56.
%	\end{align*}
%	Số tam giác suy biến (tam giác có $3$ điểm thẳng hàng):
%	\begin{align*}
%		6C_3^3=6	
%	\end{align*}
...
%	\vskip 0.1cm
%	Lời giải $3$. Liệt kê các số có $3$ chữ số thỏa mãn là $106$, $115$, $124$, $133$, $142$, $151$, $160$, $205$, $214$, $223$, $232$, $241$, $250$, $304$, $313$, $322$, $331$, $340$, $403$, $412$, $421$, $430$, $502$, $511$, $520$, $60$1, $610$, $700$.
%	\vskip 0.1cm
...
%	Đáp số: $6$, $15$, $24$
	...
	\vskip 0.1cm
%	Lời giải $1$. Năm thường có $365$ ngày chia $7$ dư $1$ $\Rightarrow$ $60$ năm chia $7$ dư $60$ hay dư dư $4$
%	\vskip 0.1cm
...
%	Đáp số: Thứ $5$
	...
	\vskip 0.1cm
%	Lời giải. Gọi số đó là $\overline{abc}$.
%	\vskip 0.1cm
%	+ $b$ có $1$0 cách chọn.
%	\vskip 0.1cm
...
%	Đáp số: $450$ 
	...
	\vskip 0.1cm
%	Hướng dẫn giải: Số cách lát hình chữ nhật $k(m) \times 2(m)$ bằng các viên gạch $1(m)\times2(m)$ chính là dãy Fibonacci $1,2,3,5,8,\ldots$. Vậy số cách lát là: $F5 = 8$.
%	\vskip 0.1cm
%	Đáp số: $8$
	\vskip 0.1cm
