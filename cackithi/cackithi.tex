...
\begin{multicols}{2}
	...
	\begin{figure}[H]
		...
		\vspace*{-10pt}
	\end{figure}
	\textbf{\color{cackithi}Bài} $\pmb{4.}$ Tháp gỗ bên được xếp bằng các viên gỗ nhỏ hình lập phương, viên này chồng lên viên kia. Có một số viên gỗ không nhìn thấy được.
	\vskip 0.1cm
	...
	\begin{figure}[H]
		...
		\vspace*{-10pt}
	\end{figure}
	\textbf{\color{cackithi}Bài} $\pmb{5.}$ Hình chữ nhật bên được chia thành bốn hình tam giác có diện tích là $2$, $3$, $5$ và $X$ như hình vẽ.
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
		\captionsetup{labelformat= empty, justification=centering}
	...
	Tính giá trị của $X$?
	\vskip 0.1cm 	 
	\textbf{\color{cackithi}Bài} $\pmb{6.}$ Hình bên có bao nhiêu hình tam giác?
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
		\captionsetup{labelformat= empty, justification=centering}
		...
		\vspace*{-10pt}
	\end{figure}
	\textbf{\color{cackithi}Bài} $\pmb{7.}$ Các ô vuông của hình bên được điền các số tự nhiên khác $0$ sao cho trên mỗi hàng là các số khác nhau, và số nằm ở ô vuông bên trên bằng tích của hai số được ghi ở hai ô vuông nằm bên dưới nó.
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
		\captionsetup{labelformat= empty, justification=centering}
	...
	\vskip 0.1cm	
	\textbf{\color{cackithi}Bài} $\pmb{8.}$ Cho $8$ điểm nằm trên một lưới ô vuông như hình vẽ bên. Hỏi có bao nhiêu tam giác có các đỉnh trùng với $8$ điểm đã cho.
	\begin{figure}[H]
		\centering
		\vspace*{-5pt}
		\captionsetup{labelformat= empty, justification=centering}
